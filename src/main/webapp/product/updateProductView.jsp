	...
	<form name="detailForm">
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0"
			...
			<tr>
				...
				<td bgcolor="D6D6D6" width="1"></td>
				<td class="ct_write01"><select name="stock" class="ct_input_g"
					style="width: 100px; height: 20px; overflow-y: scroll;">
