...
<table width="600" border="0" cellspacing="0" cellpadding="0"	align="center" style="margin-top: 13px;">
	...
	<tr>
		...
		<td bgcolor="D6D6D6" width="1"></td>
		<td class="ct_write01">${originProduct.price}</td>
	</tr>
		<tr>
		<td height="1" colspan="3" bgcolor="D6D6D6"></td>
	</tr>
	<tr>
		<td width="104" class="ct_write">최종결제가(회원할인포함)</td>
		<td bgcolor="D6D6D6" width="1"></td>
		<td class="ct_write01">${product.price}</td>
		<input type="hidden" name="purchasePrice" value="${originProduct.price}" />
	</tr>
	<tr>
		<td height="1" colspan="3" bgcolor="D6D6D6"></td>
	</tr>
	...
	<tr>
    	...
    	<td bgcolor="D6D6D6" width="1"></td>
    	<td class="ct_write01">
       	 <select name="quantity" class="ct_input_g" style="width: 100px; height: 20px; overflow-y: scroll;">
       	     <!-- JavaScript를 사용하여 1부터 99까지의 수량 옵션을 추가합니다 -->
       	     <script>
